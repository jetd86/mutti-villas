...
import bgHomeNightMobile1x from '@images/bg-home-night.png?w=400&format=webp&as=src';

import bgHomeNightMobile2x from '@images/bg-home-night.png?w=800&format=webp&as=src';

import bgHomeNightMobile3x from '@images/bg-home-night.png?w=1600&format=webp&as=src';
...
import bgMapMobile1x from '@images/contract-section-map.jpg?w=1500&format=webp&as=src';

import bgMapMobile2x from '@images/contract-section-map.jpg?w=1500&format=webp&as=src';

import bgMapMobile3x from '@images/contract-section-map.jpg?w=1500&format=webp&as=src';

import bgMapMobile4x from '@images/contract-section-map.jpg?w=1500&format=webp&as=src';

import bgMapTablet1x from '@images/contract-section-map.jpg?w=1536&format=webp&as=src';

import bgMapTablet2x from '@images/contract-section-map.jpg?w=1536&format=webp&as=src';

import bgMapTablet3x from '@images/contract-section-map.jpg?w=2304&format=webp&as=src';

import bgMapTablet4x from '@images/contract-section-map.jpg?w=3072&format=webp&as=src';

import bgMapDesktop1x from '@images/contract-section-map.jpg?w=2048&format=webp&as=src';

import bgMapDesktop2x from '@images/contract-section-map.jpg?w=2048&format=webp&as=src';

import bgMapDesktop3x from '@images/contract-section-map.jpg?w=3072&format=webp&as=src';

import bgMapDesktop4x from '@images/contract-section-map.jpg?w=4096&format=webp&as=src';

import bgMapLarge1x from '@images/contract-section-map.jpg?w=3840&format=webp&as=src';

import bgMapLarge2x from '@images/contract-section-map.jpg?w=3840&format=webp&as=src';
...
function getMapImages() {
    return {
        mobile: {1: bgMapMobile1x, 2: bgMapMobile2x, 3: bgMapMobile3x, 4: bgMapMobile4x},
...
function loadOptimizedMap(selector, images) {
    const element = document.querySelector(selector);
    if (!element) return;
    const dpr = Math.min(Math.ceil(window.devicePixelRatio), 4);
    const width = window.innerWidth;
