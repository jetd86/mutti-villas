                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            countryCodes = {
                                ...
                                '379': { 'name': 'Vatican', 'format': '+379 ## ## ## ##', 'length': [8] },
                                ...
                                '420': { 'name': 'Czech Republic', 'format': '+420 ### ### ###', 'length': [9] },
                                ...
                                '853': { 'name': 'Macao', 'format': '+853 #### ####', 'length': [8] },
                                ...
                                '225': { 'name': "Ivory Coast", 'format': '+225 ## ## ## ##', 'length': [8] },
                                ...
                                '262': { 'name': 'Reunion/Mayotte', 'format': '+262 ##### ####', 'length': [9] },
                                ...
                                '61': { 'name': 'Australia', 'format': '+61 # #### ####', 'length': [9] },
                                '64': { 'name': 'New Zealand', 'format': '+64 ## ### ####', 'length': [9] },
                                '679': { 'name': 'Fiji', 'format': '+679 ### ####', 'length': [7] },
                                '675': { 'name': 'Papua New Guinea', 'format': '+675 ### ####', 'length': [7] },
                                '687': { 'name': 'New Caledonia', 'format': '+687 ##.##.##', 'length': [6] },
                                '689': { 'name': 'French Polynesia', 'format': '+689 ## ## ## ##', 'length': [8] },
                                '685': { 'name': 'Samoa', 'format': '+685 ## ####', 'length': [6] },
                                '684': { 'name': 'American Samoa', 'format': '+684 ###-####', 'length': [7] },
                                '676': { 'name': 'Tonga', 'format': '+676 #####', 'length': [5] },
                                '677': { 'name': 'Solomon Islands', 'format': '+677 #####', 'length': [5] },
                                '678': { 'name': 'Vanuatu', 'format': '+678 #####', 'length': [5] },
                                '682': { 'name': 'Cook Islands', 'format': '+682 ## ###', 'length': [5] },
                                '683': { 'name': 'Niue', 'format': '+683 ####', 'length': [4] },
                                '686': { 'name': 'Kiribati', 'format': '+686 ## ###', 'length': [5] },
                                '688': { 'name': 'Tuvalu', 'format': '+688 #####', 'length': [5] },
                                '691': { 'name': 'Micronesia', 'format': '+691 ### ####', 'length': [7] },
                                '692': { 'name': 'Marshall Islands', 'format': '+692 ###-####', 'length': [7] },
                                '680': { 'name': 'Palau', 'format': '+680 ### ####', 'length': [7] },
                                '670': { 'name': 'Northern Mariana Islands', 'format': '+670 ###-####', 'length': [7] },
                                '681': { 'name': 'Wallis and Futuna', 'format': '+681 ## ## ##', 'length': [6] },
                                '672': { 'name': 'Antarctica/Norfolk Island', 'format': '+672 ### ###', 'length': [6] },
                                '290': { 'name': 'Saint Helena Island', 'format': '+290 ####', 'length': [4] },
                                '247': { 'name': 'Ascension Island', 'format': '+247 ####', 'length': [4] },
                                '508': { 'name': 'Saint Pierre and Miquelon', 'format': '+508 ## ## ##', 'length': [6] },
