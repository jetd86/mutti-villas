...
$APPLICATION->SetPageProperty("TITLE", "Купить виллу на Пхукете Mutti Family Villas");
$APPLICATION->SetPageProperty("description", "Виллы Mutti Family Villas в Пхукете: от 3 до 5 спален, частные бассейны и сады. Современный дизайн в экологичном районе Чалонг, с инфраструктурой для семей. Выберите свой дом мечты — цены от 16 млн бат!");
